...
public class CalendarificTestAPIKey {
    ...
    public void test2(){
        given().
                accept(ContentType.JSON).
                queryParam("api_key","498a7ddb8def6842070165e3394f645486fd66bb").
        when().
                get("/countries").prettyPeek().
        then().assertThat().
                statusCode(200).
    ...
    @Test
    @DisplayName("Verify that see all national holidays of US for year 2019")
    public void test3(){
        ...
        //shortcut with syntax sugar (hamcrest matcher)
